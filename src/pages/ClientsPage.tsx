...
const ClientsPage = () => (
  <div className="min-h-screen">
    <SEOHead
      title="Who We Work With — Investors, Companies & Expatriates in Tanzania"
      description="We support foreign investors, international companies, SMEs, NGOs and expatriate families with advisory and consulting services across Tanzania."
      path="/clients"
    />
    <JsonLd id="breadcrumb-clients" data={breadcrumbSchema([{ name: "Home", url: "https://www.tanzaniaadvisorypartners.co.tz/" }, { name: "Clients", url: "https://www.tanzaniaadvisorypartners.co.tz/clients" }])} />
    <Navbar />
