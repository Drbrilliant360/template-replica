...
const WhyChooseUs = () => (
  <section className="relative section-padding overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 relative z-10 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
      <div className="text-center md:text-left">
        <p className="section-label">Our Advantage</p>
        <h2 className="section-title !text-primary-foreground">Why Clients Choose Us</h2>
        <p className="text-[15px] sm:text-base !text-primary-foreground/70 leading-relaxed">
      ...
      <div className="space-y-5 sm:space-y-6">
        {reasons.map((r, i) => (
          <div key={i} className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="text-[15px] sm:text-base font-semibold mb-1 !text-primary-foreground font-body">{r.title}</h3>
              <p className="text-[13px] sm:text-sm !text-primary-foreground/60 leading-relaxed">{r.desc}</p>
            </div>
          </div>
        ))}
      </div>
